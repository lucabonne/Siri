    ...
    <div>
      ...
      {hasSynced && connectorId === 'slack' && (
        <div style={{ fontSize: 10, color: 'var(--color-text-tertiary)', marginTop: 4 }}>
          Tip: invite the bot to channels with /invite @Siri, then re-sync
        </div>
      )}
      {syncError && (
        <div style={{ fontSize: 11, color: 'var(--color-error)', marginTop: 4 }}>
...
const MESSAGING_CHANNELS: MessagingChannelConfig[] = [
  {
    ...
    setupSteps: [
      ...
      '6. (Optional) Still in "Basic Information", scroll to "Display Information" \u2192 upload the Siri Layer icon as the app icon',
    ...
    howToUse: () => 'Open Slack and DM @Siri to talk to your agent.',
  },
];

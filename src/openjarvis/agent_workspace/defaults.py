...
DEFAULT_AGENT_CONFIGS = [
    {
        ...
        "memory_scope": ["project", "code", "commands_history", "agent_runs"],
    ...
    },
    {
        ...
        "memory_scope": ["project", "tasks", "agent_runs", "research_reports"],
        "permission_ceiling": "SAFE_ACTION",
        "preferred_model": "qwen3.5:9b",
    ...
    },
    {
        ...
        "memory_scope": ["commands_history", "project", "agent_runs"],
        "permission_ceiling": "CONFIRMED_EXECUTION",
        "preferred_model": "qwen3.5-coder:9b",
